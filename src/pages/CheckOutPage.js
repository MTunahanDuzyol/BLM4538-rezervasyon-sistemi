...
export function CheckOutPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setSuccess(null);
      await confirmCheckOut(reservationId.trim());
...
const styles = StyleSheet.create({
  ...
  header: { height: 56, backgroundColor: '#c2410c', justifyContent: 'center', paddingHorizontal: 16 },
  ...
  toggleButton: { height: 44, borderRadius: 10, backgroundColor: '#c2410c', alignItems: 'center', justifyContent: 'center' },
  ...
  primaryButton: { height: 44, borderRadius: 10, backgroundColor: '#c2410c', alignItems: 'center', justifyContent: 'center' },
